...
if __name__ == "__main__":
    ...
    inv = Eikonal_Inversion((y,x), (ny,nx), "./input_data_80s_xy.csv", root_folder="./real_data_80s_DA2", eta = 2, epsilon=2, BL = (11,44.4), transform=True)
    ...
    print(inv.run_nonlinear(mode = "DA", bounds = bounds, no_local_search=False, maxfun=5000))
